...
//-----------------------------------------------------------------------------
// 基本速度
const int BASE_POWER = 56; //基本のモータ出力
const int SLOW_POWER = 50; //ダブルループに入った時用の出力
...
// 色判別HSV閾値
const int BLUE_HUE_MIN = 210; //青だと認識する最低H値
const int BLUE_HUE_MAX = 240; //青だと認識する最高H値

const int BLUE_SATURATION_MIN = 55; //青だと認識する最低S値

const int BLUE_VALUE_MIN = 150; //青だと認識する最低V値
const int BLUE_VALUE_MAX = 230; //青だと認識する最高V値
...
const uint32_t STRAIGHT_DURATION_MS = 140;
